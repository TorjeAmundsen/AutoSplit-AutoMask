...
Adjust X, Y, Width, and Height to crop the capture source before it is scaled to 320x240. This is useful for cropping out OBS Virtual Cam's black bars. **Reset crop** restores the crop to the full source dimensions.
